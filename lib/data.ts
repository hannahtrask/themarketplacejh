...
export const valueProps = [
    ...
    },
    {
        title: "Get Matched",
        description:
            "Submit what you need. We find the right person. You collaborate directly."
    },
    {
...
export const processSteps: ProcessStep[] = [
    ...
    },
    {
        ...
        description:
            "Work directly together. 10% commission goes back to community events.",
        iconLabel: "C"
    }
];
...
export const faqs: FAQItem[] = [
    {
        ...
        answer:
            "Anyone creating something real. Designers, developers, artists, writers, marketers, illustrators-if you're building and want community + work opportunities, you're in."
    },
    {
        question: "What's the 10% commission?",
        answer:
            "When someone gets matched with work through The Marketplace, we take 10% of the project fee. It goes directly back into community events and keeping the platform running."
    },
    {
    ...
    },
    {
        ...
        answer:
            "No. Being in the directory is completely free. The only cost is the 10% commission if you get work through The Marketplace."
    },
    {
